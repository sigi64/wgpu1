...
pub type Positions = Vec<[f32; 3]>;
pub type Normals = Vec<[f32; 3]>;
...
pub fn torus_data(
    ...
    for i in 0..n_torus - 1 {
        for j in 0..n_tube - 1 {
            ...
            let p0 = math_fn::torus_position(r_torus, r_tube, Deg(u), Deg(v));
            let p1 = math_fn::torus_position(r_torus, r_tube, Deg(u1), Deg(v));
            let p2 = math_fn::torus_position(r_torus, r_tube, Deg(u1), Deg(v1));
            let p3 = math_fn::torus_position(r_torus, r_tube, Deg(u), Deg(v1));
...
pub fn sphere_data(r: f32, u: usize, v: usize) -> (Positions, Normals, Vec<[f32; 2]>) {
    ...
    for i in 0..u - 1 {
        for j in 0..v - 1 {
            ...
            let p0 = math_fn::sphere_position(r, Deg(theta), Deg(phi));
            let p1 = math_fn::sphere_position(r, Deg(theta1), Deg(phi));
            let p2 = math_fn::sphere_position(r, Deg(theta1), Deg(phi1));
            let p3 = math_fn::sphere_position(r, Deg(theta), Deg(phi1));
